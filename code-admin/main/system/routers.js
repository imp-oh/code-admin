...
let index = require('@/main/system/api/index')
let systemUser = require('@/main/system/api/system/user')
let userProfile = require('@/main/system/api/system/user/profile')
let dict = require('@/main/system/api/system/dict/data')
let typeConfig = require('@/main/system/api/system/dict/type')
let dept = require('@/main/system/api/system/dept')
let deptListConfig = require('@/main/system/api/system/dept/list')
let apiConfig = require('@/main/system/api/system/config')
let roleConfig = require('@/main/system/api/system/role')
let menuConfig = require('@/main/system/api/system/menu')
let authUserConfig = require('@/main/system/api/system/role/authUser')
let postConfig = require('@/main/system/api/system/post')
let noticeConfig = require('@/main/system/api/system/notice')

let operlogConfig = require('@/main/system/api/monitor/operlog')
let logininforConfig = require('@/main/system/api/monitor/logininfor')
let onlineConfig = require('@/main/system/api/monitor/online')
let jobConfig = require('@/main/system/api/monitor/job')
let serverConfig = require('@/main/system/api/monitor/server')
let cacheConfig = require('@/main/system/api/monitor/cache')
let genConfig = require('@/main/system/api/tool/gen')
