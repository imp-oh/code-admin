...
let userMapper = require('@/main/system/db/sysUserMapper')
let userPostMapper = require('@/main/system/db/sysUserPostMapper')
let userRoleMapper = require('@/main/system/db/sysUserRoleMapper')
let roleMapper = require('@/main/system/db/sysRoleMapper')
let postMapper = require('@/main/system/db/sysPostMapper')
 ...
 * @return
 */
let checkEmailStatus = async (user = {}) => {
  let [info] = await dbconfig.sqlConnect(userMapper.checkEmailStatus, user.email)
  return info
}
